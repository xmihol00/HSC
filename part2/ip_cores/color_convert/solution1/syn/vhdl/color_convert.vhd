...
architecture behav of color_convert is 
    ...
    "color_convert,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=6,HLS_SYN_FF=1099,HLS_SYN_LUT=1009,HLS_VERSION=2020_1}";
    ...
    signal regslice_both_stream_out_24_data_U_apdone_blk : STD_LOGIC;
    ...
    signal regslice_both_stream_in_24_data_U_apdone_blk : STD_LOGIC;
    ...
    signal regslice_both_stream_in_24_data_U_ack_in : STD_LOGIC;
    ...
    signal regslice_both_stream_out_24_data_U_vld_out : STD_LOGIC;
...
begin
    ...
    regslice_both_stream_in_24_data_U : component regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_out_24_data_U : component regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                p_Repl2_1_reg_925 <= stream_in_24_TDATA_int(15 downto 8);
                p_Repl2_2_reg_930 <= stream_in_24_TDATA_int(23 downto 16);
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter6, regslice_both_stream_out_24_data_U_apdone_blk, stream_in_24_TVALID_int)
    begin
                ap_block_pp0_stage0_01001 <= (((regslice_both_stream_out_24_data_U_apdone_blk = ap_const_logic_1) and (ap_enable_reg_pp0_iter6 = ap_const_logic_1)) or ((stream_in_24_TVALID_int = ap_const_logic_0) and (ap_const_logic_1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter6, regslice_both_stream_out_24_data_U_apdone_blk, stream_in_24_TVALID_int, stream_out_24_TREADY_int)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter6 = ap_const_logic_1) and ((stream_out_24_TREADY_int = ap_const_logic_0) or (regslice_both_stream_out_24_data_U_apdone_blk = ap_const_logic_1))) or ((stream_out_24_TREADY_int = ap_const_logic_0) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1)) or ((stream_in_24_TVALID_int = ap_const_logic_0) and (ap_const_logic_1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter6, regslice_both_stream_out_24_data_U_apdone_blk, stream_in_24_TVALID_int, stream_out_24_TREADY_int)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter6 = ap_const_logic_1) and ((stream_out_24_TREADY_int = ap_const_logic_0) or (regslice_both_stream_out_24_data_U_apdone_blk = ap_const_logic_1))) or ((stream_out_24_TREADY_int = ap_const_logic_0) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1)) or ((stream_in_24_TVALID_int = ap_const_logic_0) and (ap_const_logic_1 = ap_const_logic_1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(stream_in_24_TVALID_int)
    begin
                ap_block_state1_pp0_stage0_iter0 <= (stream_in_24_TVALID_int = ap_const_logic_0);
    end process;
    ...
    ap_block_state7_pp0_stage0_iter6_assign_proc : process(regslice_both_stream_out_24_data_U_apdone_blk)
    begin
                ap_block_state7_pp0_stage0_iter6 <= (regslice_both_stream_out_24_data_U_apdone_blk = ap_const_logic_1);
    end process;
    ...
    p_Repl2_s_fu_215_p1 <= stream_in_24_TDATA_int(8 - 1 downto 0);
    ...
    stream_in_24_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, stream_in_24_TVALID_int)
    begin
    ...
    stream_in_24_TREADY_assign_proc : process(stream_in_24_TVALID, regslice_both_stream_in_24_data_U_ack_in)
    begin
        if (((stream_in_24_TVALID = ap_const_logic_1) and (regslice_both_stream_in_24_data_U_ack_in = ap_const_logic_1))) then 
    ...
    stream_in_24_TREADY_int_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001)
    begin
    ...
    stream_out_24_TDATA_blk_n_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter6, stream_out_24_TREADY_int)
    begin
    ...
    stream_out_24_TDATA_int <= ((out3_V_fu_846_p3 & out2_V_fu_788_p3) & out1_V_fu_730_p3);
    stream_out_24_TVALID <= regslice_both_stream_out_24_data_U_vld_out;

    stream_out_24_TVALID_int_assign_proc : process(ap_enable_reg_pp0_iter5, ap_block_pp0_stage0_11001)
    begin
