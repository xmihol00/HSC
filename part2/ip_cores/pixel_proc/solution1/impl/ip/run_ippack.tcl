...
set Library     "hls"
set IPName      "pixel_proc"
set Version     "1.0"
set DisplayName "Pixel Processing"
set Revision    "2103011301"
set Description "Pixel processing for 24-bit AXI video stream"
set Device      "zynq"
set AutoFamily  ""
...
set sdx_kernel_name "pixel_proc"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/mnt/sdc3/david/projs/hardware-software/part2/ip_cores/pixel_proc/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {pixel_proc_mul_21ns_27s_48_7_1
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 frames_V R 0x0 "Data signal of frames_V" {{0 32 frames_V R 0 "Bit 31 to 0 Data signal of frames_V"}}} {0x14 frames_V_ctrl R 0x0 "Control signal of frames_V" {{0 1 frames_V_ap_vld R 0 "Control signal frames_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 rows_V R 0x0 "Data signal of rows_V" {{0 32 rows_V R 0 "Bit 31 to 0 Data signal of rows_V"}}} {0x1c rows_V_ctrl R 0x0 "Control signal of rows_V" {{0 1 rows_V_ap_vld R 0 "Control signal rows_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 pixels_V R 0x0 "Data signal of pixels_V" {{0 32 pixels_V R 0 "Bit 31 to 0 Data signal of pixels_V"}}} {0x24 pixels_V_ctrl R 0x0 "Control signal of pixels_V" {{0 1 pixels_V_ap_vld R 0 "Control signal pixels_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 sum_before_V R 0x0 "Data signal of sum_before_V" {{0 32 sum_before_V R 0 "Bit 31 to 0 Data signal of sum_before_V"}}} {0x2c sum_before_V_ctrl R 0x0 "Control signal of sum_before_V" {{0 1 sum_before_V_ap_vld R 0 "Control signal sum_before_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 sum_after_V R 0x0 "Data signal of sum_after_V" {{0 32 sum_after_V R 0 "Bit 31 to 0 Data signal of sum_after_V"}}} {0x34 sum_after_V_ctrl R 0x0 "Control signal of sum_after_V" {{0 1 sum_after_V_ap_vld R 0 "Control signal sum_after_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 values_V R 0x0 "Data signal of values_V" {{0 32 values_V R 0 "Bit 31 to 0 Data signal of values_V"}}} {0x3c values_V_ctrl R 0x0 "Control signal of values_V" {{0 1 values_V_ap_vld R 0 "Control signal values_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 read_done_V R 0x0 "Data signal of read_done_V" {{0 1 read_done_V R 0 "Bit 0 to 0 Data signal of read_done_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 read_done_V_ctrl R 0x0 "Control signal of read_done_V" {{0 1 read_done_V_ap_vld R 0 "Control signal read_done_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 write_ready_V W 0x0 "Data signal of write_ready_V" {{0 1 write_ready_V W 0 "Bit 0 to 0 Data signal of write_ready_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "shared_memory_V {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 7 machine 64 combinational 0 latency 2571 II x}
